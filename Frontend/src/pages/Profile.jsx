  ...
  const [updateSuccess, setUpdateSuccess] = useState(false);
    ...
    return (
      ...
      <input
        ...
        <input type="email" placeholder='email' id='email' className='border p-3 rounded-lg'  value={currentUser.email} />
        <input type="password" placeholder='password' id='password' className='border p-3 rounded-lg' value={currentUser.password}  />
        <button
          disabled={loading}
